...
/**
 * Stamps every page of a PDF with a "Verified" badge — verifier name and
 * date, boxed like a rubber stamp, bottom-right corner. Works on the PDF
 * bytes directly, so the original content is never touched.
 */
export async function stampPdf(pdfBytes, { verifiedByName, verifiedAt }) {
