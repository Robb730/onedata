...
function ActionConfirmModal({ open, kind, request, onClose, onConfirm, isWorking }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div
        className="w-full max-w-sm max-h-[90dvh] overflow-y-auto bg-white rounded-t-2xl sm:rounded-2xl shadow-[0_32px_80px_rgba(15,23,42,0.25)] border border-slate-200"
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 px-4 pt-2 pb-3 lg:px-6 lg:pt-7 lg:pb-5 border-b border-slate-100 shrink-0 bg-gradient-to-b from-slate-50/80 to-white relative overflow-hidden">
          ...
          <button onClick={handleClose} className="relative z-10 p-2 rounded-xl hover:bg-slate-100 text-slate-400 hover:text-slate-600 transition-colors shrink-0">
        ...
        <div className="flex items-center gap-1 px-3 lg:px-4 pt-3 shrink-0">
          {[
            ...
            <button
              ...
              className={`flex-1 min-w-0 inline-flex items-center justify-center gap-1 px-2 lg:px-3 py-2 rounded-lg text-[11px] lg:text-[12.5px] font-bold transition-colors ${
                tab === t.key
