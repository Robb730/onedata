  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[10] pointer-events-none overflow-hidden">
        <div className="absolute top-[14%] left-[38%] w-10 h-10 md:w-12 md:h-12 rounded-full bg-indigo-300/30 backdrop-blur-[2px] shadow-[0_0_20px_rgba(165,180,252,0.3)] animate-float-slow" style={{ animationDelay: "0s" }} />
        <div className="absolute top-[42%] left-[6%] w-9 h-9 md:w-11 md:h-11 rounded-full bg-[#1d4ed8] opacity-90 shadow-[0_4px_16px_rgba(29,78,216,0.6)] animate-float-reverse" style={{ animationDelay: "0.5s" }} />
        <div className="absolute top-[67%] left-[23%] w-6 h-6 md:w-7 md:h-7 rounded-full bg-[#1e40af]/85 shadow-md animate-float-slow" style={{ animationDelay: "1.2s" }} />
        <div className="absolute top-[10%] left-[78.5%] w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#34d399]/75 shadow-[0_0_15px_rgba(52,211,153,0.5)] animate-float-reverse" style={{ animationDelay: "0.8s" }} />
        <div className="absolute top-[43%] left-[91.5%] w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#34d399]/75 shadow-[0_0_12px_rgba(52,211,153,0.5)] animate-float-slow" style={{ animationDelay: "1.5s" }} />
        <div className="absolute top-[66%] left-[64.5%] w-9 h-9 md:w-10 md:h-10 rounded-full bg-[#6ee7b7]/45 backdrop-blur-[1px] shadow-[0_0_18px_rgba(110,231,183,0.4)] animate-float-reverse" style={{ animationDelay: "0.2s" }} />
      </div>

      {/* Education Data Overview content */}
        ...
        <div className="max-w-xl text-left">
          ...
          >
            <div className="w-4 h-4 rounded-full overflow-hidden flex items-center justify-center bg-white/20 shrink-0">
              <img src={sdoLogo} alt="DepEd SDO Logo" className="w-full h-full object-cover" />
            </div>
          ...
          >
            ...
            <br />
            <span
              className="inline-block mt-0.5 font-extrabold animate-gradient-shift"
              style={{
                background: "linear-gradient(90deg, #38bdf8 0%, #2dd4bf 30%, #34d399 60%, #38bdf8 100%)",
          ...
          {/* CTA Button */}
          <div className="animate-hero-fade-up" style={{ animationDelay: "0.55s" }}>
            <button
      ...
      <style>{`
        @keyframes bgEntrance {
          0%   { opacity: 0.1; transform: scale(1.12); }
        ...
        .animate-bg-entrance    { animation: bgEntrance    1.6s cubic-bezier(0.16,1,0.3,1) forwards; }
        .animate-waves-entrance { animation: wavesEntrance 1.3s cubic-bezier(0.16,1,0.3,1) 0.25s both; }
        .animate-hero-fade-up   { animation: heroFadeUp    0.8s cubic-bezier(0.16,1,0.3,1) both; }
